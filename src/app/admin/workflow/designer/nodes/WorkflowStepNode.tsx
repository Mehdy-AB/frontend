...
import { Clock, Users, Edit, Trash2, CheckCircle, XCircle } from 'lucide-react';
...
const WorkflowStepNode = ({ data, selected, id }: WorkflowStepNodeProps) => {
    return (
        <div
        ...
        >
            ...
            <div className="mb-2 pr-10">
                <div className="font-bold text-sm text-gray-900 leading-tight">{data.label || 'Approval Step'}</div>
            ...
            {/* Output Handles - Approved (Top) and Denied (Bottom) */}
            <div className="absolute right-0 top-0 bottom-0 flex flex-col justify-center items-end pr-0" style={{ right: -12 }}>
                ...
                <div className="flex items-center gap-1 mb-4">
                    ...
                    <Handle
                        ...
                        id="approved"
                        className="!relative !transform-none w-4 h-4 bg-green-500 border-2 border-white transition-transform hover:scale-125"
                        style={{ right: 0, top: 0 }}
                    />
                </div>
                ...
                <div className="flex items-center gap-1">
                    ...
                    <Handle
                        ...
                        position={Position.Right}
                        id="denied"
                        className="!relative !transform-none w-4 h-4 bg-red-500 border-2 border-white transition-transform hover:scale-125"
                        style={{ right: 0, top: 0 }}
                    />
                </div>
            </div>
