...
const messages = {
  en: {
    ...
    'admin.manageUsersRolesGroups': 'Manage users, roles, and groups with comprehensive permissions',
  ...
  fr: {
    ...
    'admin.manageUsersRolesGroups': 'Gérer les utilisateurs, rôles et groupes avec des permissions complètes',
  ...
  ar: {
    ...
    'admin.manageUsersRolesGroups': 'إدارة المستخدمين والأدوار والمجموعات مع صلاحيات شاملة',
